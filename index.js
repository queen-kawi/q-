...
const sessdata = config.SESSION_ID.split("SANU-MD~")[1];
...
async function connectToWA() {
  ...
  console.log("Connecting 𝑄𝑈𝐸𝐸𝑁 𝑆𝐴𝑁𝑈 ✅");
  ...
  robin.ev.on("connection.update", (update) => {
    ...
    if (connection === "close") {
      ...
      console.log("𝑄𝑈𝐸𝐸𝑁 𝑆𝐴𝑁𝑈-MD installed successful ✅");
      console.log("𝑄𝑈𝐸𝐸𝑁 𝑆𝐴𝑁𝑈-MD connected to whatsapp ✅");

      let up = `𝑄𝑈𝐸𝐸𝑁 𝑆𝐴𝑁𝑈 𝚂𝚄𝙲𝙲𝙴𝚂𝚂𝙵𝚄𝙻𝙻𝚈 𝙲𝙾𝙽𝙽𝙴𝙲𝚃𝙴𝙳`;
      let up1 = `𝑄𝑈𝐸𝐸𝑁 𝑆𝐴𝑁𝑈 𝚂𝚄𝙲𝙲𝙴𝚂𝚂𝙵𝚄𝙻𝙻𝚈 𝙲𝙾𝙽𝙽𝙴𝙲𝚃𝙴𝙳 ✅`;
...
app.get("/", (req, res) => {
  res.send("𝑄𝑈𝐸𝐸𝑁 𝑆𝐴𝑁𝑈 𝚂𝚄𝙲𝙲𝙴𝚂𝚂𝙵𝚄𝙻𝙻𝚈 𝙲𝙾𝙽𝙽𝙴𝙲𝚃𝙴𝙳  ✅");
});
app.listen(port, () =>
